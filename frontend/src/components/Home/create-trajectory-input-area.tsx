...
export default function CreateTrajectoryInputArea({
    ...
    return (
        <>
            <div className="pt-8 w-full max-w-[680px]"></div>
            <form
            ...
            >
                ...
                <div className="w-full flex flex-row justify-between items-center pt-0 mb-0">
                    <div className="flex flex-row gap-x-2 items-center flex-grow mr-4">
                        <label
                            htmlFor="start-url"
                            className="text-14-regular-body text-gray-5 whitespace-nowrap"
                        >
                            Starting at:
                        </label>
                        <input
                            ...
                            className="text-14-regular-body text-gray-6 bg-transparent border-0 focus:ring-0 focus:outline-none p-0 w-full"
